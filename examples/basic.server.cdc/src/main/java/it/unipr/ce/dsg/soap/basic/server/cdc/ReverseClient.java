...
public class ReverseClient { 
   ...
   public ReverseClient(String instanceName) {
   ...
   public static void main( String args[] ) {
   	...
   	ReverseClient consumerPeer = new ReverseClient("ConsumerPeer");
   ...
   private void discoverServices(){
     ...
     //  Vector<ModuleSpecAdvertisement> serviceAdvs = new Vector<ModuleSpecAdvertisement>();
       ...
       System.out.println("Searching for 'ReverseService'");
   ...
   private void interactWithService() {
       try {
           System.out.println("\n# Create ServiceDescriptor for 'ReverseService' from msadv");
           System.out.println("--------------------------------------------------------");
           ServiceDescriptor desc1 = new ServiceDescriptor("Reverse",
                               msadv,
                               null, // no policy 
                               netPeerGroup );	
        ...
        //   SoapSerializationEnvelope envelope =callFactory.getEnvelope(requestObject);
          ...
          long totalTime = 0;
           while( i-- > 0 ) {         
              ...
              transport.call("Reverse", envelope);
